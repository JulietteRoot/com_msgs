...
// TODO : changer les valeurs et indenter
	...
	<div id="filter-bar" class="btn-toolbar">
		<div class="filter-search btn-group pull-left">
			<input type="text" name="filter_search" id="filter_search"
				...
				class="hasTooltip"
				title="<?php echo JHtml::tooltipText('COM_MESSAGES_SEARCH_IN_SUBJECT'); ?>" />
		</div>
				...
				<?php
					foreach ( $this->items as $i => $item ) :
						...
						<tr class="row<?php echo $i % 2; ?>">
							<td><?php echo JHtml::_('grid.id', $i, $item->message_id); ?></td>
							<td><a href="<?php echo JRoute::_('index.php?option=com_messages&view=message&message_id='.(int) $item->message_id); ?>">
								<?php echo $this->escape($item->subject); ?></a></td>
